        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link
              ...
              className="w-fit sm:w-auto px-5 py-2.5 md:px-8 md:py-4 rounded-full bg-accent-500 text-white font-bold text-base md:text-lg hover:bg-accent-400 hover:scale-105 transition-all shadow-lg shadow-accent-500/30 flex items-center justify-center group"
            >
              {primaryButtonText}
            ...
            <Link
              ...
              className="w-fit sm:w-auto px-5 py-2.5 md:px-8 md:py-4 rounded-full bg-white/10 text-white font-bold text-base md:text-lg border border-white/20 hover:bg-white/20 transition-all flex items-center justify-center"
            >
              {secondaryButtonText}
            </Link>
          </div>
