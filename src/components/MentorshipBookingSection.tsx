                ...
                <div className="space-y-1.5">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <button 
                      ...
                      className={`p-4 rounded-2xl border transition-all text-left ${amount === 30000 ? "border-primary-900 bg-primary-50/50 ring-2 ring-primary-900/10" : "border-gray-100 bg-gray-50/50 hover:border-gray-200"}`}
                    >
                      <p className="font-bold text-gray-900">Single Session</p>
                      <p className="text-xs text-gray-500">90 minutes • ₦30,000</p>
                    </button>
                    <button 
                      type="button"
