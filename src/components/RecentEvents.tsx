  ...
  return (
    <SectionWrapper id="upcoming-events" className="bg-white border-t border-gray-100">
      ...
      <div className="mt-10 md:hidden flex justify-center">
        <Link 
          href="/events" 
          className="inline-flex items-center justify-center px-6 py-2 md:px-6 md:py-3 rounded-full bg-white border border-gray-200 text-primary-700 font-semibold hover:bg-gray-50 transition-colors w-fit text-sm md:text-base"
        >
          View All Events
