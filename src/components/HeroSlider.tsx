            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
                <Link
                  ...
                  className="px-3 py-1.5 md:px-8 md:py-4 rounded-full bg-primary-500 text-white font-bold text-[10px] md:text-lg hover:bg-primary-600 hover:shadow-xl hover:shadow-primary-500/30 transition-all transform hover:-translate-y-1 text-center"
                >
                  {slides[currentSlide].cta1}
                </Link>
                <Link
                  href={slides[currentSlide].cta2Link}
                  className="px-3 py-1.5 md:px-8 md:py-4 rounded-full bg-white/10 backdrop-blur-md text-white font-bold text-[10px] md:text-lg border border-white/30 hover:bg-white/20 transition-all flex items-center justify-center text-center group"
                >
