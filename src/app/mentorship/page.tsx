    ...
    <>
      <section className="bg-gradient-to-br from-primary-950 to-primary-900 py-24 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          <Link
            href="/contact"
            className="inline-flex items-center justify-center px-8 py-4 rounded-full bg-white text-primary-900 font-bold text-lg hover:bg-gray-100 hover:scale-105 transition-all shadow-xl"
          >
