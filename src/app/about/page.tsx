    ...
    <>
      ...
      <section className="bg-[#051a14] py-24 md:py-36 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          <h1 className="text-3xl md:text-6xl lg:text-8xl font-medium text-white mb-10 tracking-tight max-w-5xl mx-auto font-serif italic leading-[1.1]">
          ...
          <p className="text-lg md:text-2xl text-primary-100/80 max-w-4xl mx-auto leading-relaxed font-light">
