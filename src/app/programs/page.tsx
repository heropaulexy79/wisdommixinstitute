      ...
      <div className="py-20 bg-white">
        {programs.map((program, index) => (
          <SectionWrapper 
            key={program.id} 
            id={program.id}
            className={`!py-16 ${index !== programs.length - 1 ? "mb-8 lg:mb-16" : ""}`}
            delay={0.1}
          >
            <div className={`rounded-3xl border ${program.borderColor} bg-gradient-to-br ${program.bgPrimary} p-8 md:p-12 lg:p-16 shadow-sm overflow-hidden relative`}>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
                <div>
                  ...
                  <a 
                    href="/contact" 
                    className="inline-flex items-center px-6 py-3 rounded-full bg-primary-600 text-white font-semibold hover:bg-primary-700 transition-colors shadow-sm"
                  >
