    ...
    <>
      <section className="bg-primary-950 py-24 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          <Link
            href="/contact"
            className="inline-flex items-center justify-center px-8 py-3 md:px-8 md:py-4 rounded-full bg-accent-500 text-white font-bold text-base md:text-lg hover:bg-accent-400 hover:scale-105 transition-all shadow-lg shadow-accent-500/30"
          >
            Apply to Join Today
